CREATE TABLE IF NOT EXISTS `gw2_recipes` (
  `recipe_id` int(6) unsigned NOT NULL DEFAULT '0',
  `output_id` int(6) unsigned NOT NULL DEFAULT '0',
  ...
  `ing_id_1` int(6) unsigned NOT NULL DEFAULT '0',
  `ing_count_1` SMALLINT(3) unsigned NOT NULL DEFAULT '0',
  `ing_id_2` int(6) unsigned NOT NULL DEFAULT '0',
  `ing_count_2` SMALLINT(3) unsigned NOT NULL DEFAULT '0',
  `ing_id_3` int(6) unsigned NOT NULL DEFAULT '0',
  `ing_count_3` SMALLINT(3) unsigned NOT NULL DEFAULT '0',
  `ing_id_4` int(6) unsigned NOT NULL DEFAULT '0',

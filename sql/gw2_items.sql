CREATE TABLE IF NOT EXISTS `gw2_items` (
  ...
  `desc_de` tinytext COLLATE utf8_bin NOT NULL,
  `desc_en` tinytext COLLATE utf8_bin NOT NULL,
  `desc_es` tinytext COLLATE utf8_bin NOT NULL,
  `desc_fr` tinytext COLLATE utf8_bin NOT NULL,
